...
if(isset($_REQUEST['submit'])){
    ...
    $query= "SELECT * FROM products join category on products.categoryId = category.cid where productName='$pname';";
}
else{
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
           <form action="">
            ...
            <input type="submit" value="Search Product" name="submit">
           </form>
