async function getProductDataJs(){
     ...
     let result = await fetch('http://localhost:8000/getproduct');
...
async function getProductByCat(cid){
    ...
    if(cid==0){
        ...
        url = 'http://localhost:8000/getproduct/'+cid
    }
...
function prepareProductCatalog(data){
    ...
    data.map((index)=>{
        ...
        <div class="card text-black">
          ...
          <img style="height:300px" src="http://localhost:8000/uploads/product/${index.image}"
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between total font-weight-bold mt-4">
              ...
              <a href="#" class="btn btn-dark">AddToCart</a>
            </div>
          </div>
        </div>
      </div>
